...
## @tutorial : https://github.com/LegionGames/Conductor-Example/
var perfect = false
var good = false
var okay = false
...
## Update the score when the input is pressed
## perfect = 3, good = 2, okay = 1, missed = 0
